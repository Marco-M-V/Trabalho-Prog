...
Dentro da tumba existem caixas misteriosas — mas uma delas pode conter uma cobra mortal.
Os jogadores devem escolher cuidadosamente suas ações, utilizando estratégia, sorte e coragem para escapar.

Características:
Ambientação temática egípcia
...
Essas criaturas possuem habilidades especiais:

Podem se dividir, aumentando seu número no campo de batalha;

Acumulam fúria sempre que são atacadas, tornando-se mais fortes ao longo da partida.

O objetivo é administrar recursos, planejar ataques e evoluir suas Gousmas para dominar o adversário.

Características:
Estratégia tática
Sistema de evolução por fúria
...
Escolha um dos mini jogos disponíveis no menu.
